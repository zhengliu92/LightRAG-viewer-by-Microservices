...
export function KBSidebarProvider({ children, duration = 300 }: { children: React.ReactNode, duration?: number }) {
...
export function useKBSidebar() {
  ...
  if (context === undefined) {
    throw new Error('useKBSidebar must be used within a KBSidebarProvider')
  }
  return context
}